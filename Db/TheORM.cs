...
namespace the_billing_concept.Db
{
    class TheORM
    {
        private Db db;
                ...
                foreach (PropertyInfo pi in this.GetType().GetProperties())
                {
                    ...
                    if (pi != null && pi.CanWrite)
                    {
                        if (row.ContainsKey(propertyName))
                        {
                            ...
                            {
                                pi.SetValue(this, decimal.Parse(row[propertyName]));
                            }
                        }
                    }
                }
        ...
        public int create()
        {
            ...
            if (this.Properties.Count > 0)
            {
               ...
               /// fieldsvals.RemoveAt(pk_index);
                ...
                Console.WriteLine("sFields  " + sFields);
                Console.WriteLine("sField vals  " + String.Join(",", fields));
